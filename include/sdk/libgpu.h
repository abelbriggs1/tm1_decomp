#ifndef __SDK_LIBGPU_H__
#define __SDK_LIBGPU_H__
...
extern unsigned int DrawSyncCallback(void (*func)());
extern void SetDispMask(int mask);
extern int DrawSync(int mode);
extern void DrawPrim(void*);
extern int ClearImage(RECT* rect, unsigned char r, unsigned char g, unsigned char b);
extern int LoadImage(RECT* rect, unsigned int* p);
extern int StoreImage(RECT* rect, unsigned int* p);
extern int MoveImage(RECT* rect, int x, int y);
extern unsigned int* ClearOTag(unsigned int* ot, int n);
extern unsigned int* ClearOTagR(unsigned int* ot, int n);
extern void DrawOTag(unsigned int* p);
extern DRAWENV* PutDrawEnv(DRAWENV* env);
extern DISPENV* PutDispEnv(DISPENV* env);

#endif // __SDK_LIBGPU_H__
